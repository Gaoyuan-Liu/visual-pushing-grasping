...
def main(args):
    ...
    # print("YOU WANNA KNOW THIS:" + str(logging_directory))

    # Set random seed
    np.random.seed(random_seed)

    # Initialize pick-and-place system (camera and robot)
    # GY: Here is when the simulation system spawn objects
    ...
    # Output: Creating data logging session: /home/liu/visual-pushing-grasping/logs/2021-10-30.17:04:31

    # Action
    primitive_position = [0.3,0.3,1.1]
    best_rotation_angle = 90
