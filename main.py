...
def main(args):
    ...
    while True:
        ...
        if 'prev_color_img' in locals():
            ...
            # Backpropagate
            trainer.backprop(prev_color_heightmap, prev_valid_depth_heightmap, prev_primitive_action, prev_best_pix_ind, label_value) # gaoyuan change
            ...
            if experience_replay and not is_testing:
                ...
                if sample_ind.size > 0:
                    ...
                    with torch.no_grad(): # gaoyuan change
        ...
        torch.cuda.empty_cache()#new added gaoyuan change
